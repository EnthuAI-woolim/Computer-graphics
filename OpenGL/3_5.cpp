...
factor : 비트당 몇 픽셀을 그릴지 결정
ex) 1이면 1픽셀, 2면 2픽셀

pattern : 비트패턴(오른쪽에서 왼쪽으로 읽어야됨)
ex) factor: 1, patten: 0x00ff => 0000 0000 1111 1111 =>  4픽셀 그리기, 4픽셀 그리기, 4픽셀 비우기, 4픽셀 비우기
*/
